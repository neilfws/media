...
twim_df %>% 
  ...
  geom_density_ridges() + 
  theme_ridges() + 
  labs(x = "Duration (minutes)", y = "Year", title = "This Week in Microbiology Episode Duration Distribution By Year") +
  scale_x_continuous(breaks = seq(0, 150, 30))
```
...
twip_df %>% 
  ...
  geom_density_ridges() + 
  theme_ridges() + 
  labs(x = "Duration (minutes)", y = "Year", title = "This Week in Parasitism Episode Duration Distribution By Year") +
  scale_x_continuous(breaks = seq(0, 150, 30))
```
